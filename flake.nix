    ...
    let
      ...
      sources = {
        "aarch64-darwin" = {
          ...
          hash = "sha256-Sh3gULzAXUqZA4YGMuEOoIGLV8/Ev2SEE7F5nlvl4IQ=";
        };
        "aarch64-linux" = {
          asset = "vize-aarch64-unknown-linux-gnu.tar.gz";
          hash = "sha256-ZpOZcabL0r7lLXRvJNWnn5Q7cGyCy5dqmbfNTSJFO7k=";
        };
        "x86_64-linux" = {
          asset = "vize-x86_64-unknown-linux-gnu.tar.gz";
          hash = "sha256-Iv4FKCngOIill9d5jKRcy1uzxL4fVRjjeoz5vMkPV/Q=";
        };
      };
